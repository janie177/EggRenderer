...
layout(location = 5) out flat uint outMeshId;
...
void main() 
{
    ...
    outMaterialId = 1337;       //TODO extract from instance data buffer.
    outMeshId = 666;            //TODO extract from instance data buffer.
